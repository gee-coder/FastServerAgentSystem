...
public class Tray {
    ...
    static{
        ...
        IDEA在Run->EditConfiguration在Application中对应GUI类的VM-Options中添加-Dfile.encoding=GBK
         */
        showItem = new MenuItem("打开");
        //菜单项(退出)
        exitItem = new MenuItem("退出");
        //此处不能选择ico格式的图片,要使用16*16的png格式的图片
        URL url = Tray.class.getResource("/static/agent-16.png");
